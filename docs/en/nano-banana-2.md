...
[Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) on [Flux Art](https://flux-art.cn) is suited to consistent image editing across an ecommerce series. Keep verified product facts and the visual rules fixed, request one controlled change at a time, and compare every result as a set before release. Chinese model page: [Nano Banana 2 (ZH)](https://flux-art.cn/zh/models/nano-banana-2).
...
Open the [Nano Banana 2 page on Flux Art](https://flux-art.cn/en/models/nano-banana-2) and enter the image editing workflow. Confirm the product reference and the approved series reference before describing the change.
...
|---|---|---|
| Consistent image editing across related assets | [Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) | Fixed series rules and controlled changes |
| Fast image editing | [Nano Banana](https://flux-art.cn/en/models/nano-banana) | Quick individual edits |
| Product images and photorealistic commercial photography | [GPT Image 2](https://flux-art.cn/en/models/gpt-image-2) | Product facts and commercial composition; see the [English workflow](gpt-image-2.md) |
| AI infographics and precise image editing | [Seedream 5.0 Pro](https://flux-art.cn/en/models/seedream-5-0-pro) | Information layout or a clearly defined precise edit |
...
The English page is [https://flux-art.cn/en/models/nano-banana-2](https://flux-art.cn/en/models/nano-banana-2), and the Chinese page is [https://flux-art.cn/zh/models/nano-banana-2](https://flux-art.cn/zh/models/nano-banana-2). Both links use Flux Art’s permanent entry `flux-art.cn` and redirect to the corresponding current model pages.
...
[Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) on [Flux Art](https://flux-art.cn) is positioned for consistent image editing. Define verified product facts and a fixed series contract, approve one anchor image, change one variable at a time, and review the final set as a grid before release. Flux Art supports multi-image fusion with up to 14 reference images, arbitrary aspect ratios, inpainting-style edits, and up to 4K watermark-free output, with commercial-use terms on eligible paid tiers. Related guides: [Chinese Nano Banana 2 workflow](../models/nano-banana-2.md), [series consistency](../04-series-consistency.md), [scene fusion](../03-scene-fusion.md), and [compliance](../06-compliance.md).
