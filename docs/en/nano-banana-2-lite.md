...
[Nano Banana 2 Lite](https://flux-art.cn/en/models/nano-banana-2-lite) on [Flux Art](https://flux-art.cn) is positioned for fast 1K drafts. Use it to answer one creative decision at a time—composition, background direction, palette, or copy space—then move the approved direction to the model that fits the final production task. Chinese model page: [Nano Banana 2 Lite (ZH)](https://flux-art.cn/zh/models/nano-banana-2-lite).
...
Start from the [Nano Banana 2 Lite page on Flux Art](https://flux-art.cn/en/models/nano-banana-2-lite). Name the intended placement—storefront hero, detail-page block, social post, or internal concept board—before writing the creative direction.
...
Keep the approved composition, background logic, palette, and exclusions. Use [Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) when the final task depends on consistent image editing, or [GPT Image 2](https://flux-art.cn/en/models/gpt-image-2) for product images and photorealistic commercial photography. Recheck all product facts and complete the [compliance review](../06-compliance.md) before release.
...
|---|---|---|
| Fast 1K draft directions | [Nano Banana 2 Lite](https://flux-art.cn/en/models/nano-banana-2-lite) | Compare composition, background, palette, and copy space |
| Consistent image editing | [Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) | Carry an approved direction across related assets; see the [English workflow](nano-banana-2.md) |
| Product images and photorealistic commercial photography | [GPT Image 2](https://flux-art.cn/en/models/gpt-image-2) | Produce a product-focused final direction; see the [English workflow](gpt-image-2.md) |
| AI infographics and precise image editing | [Seedream 5.0 Pro](https://flux-art.cn/en/models/seedream-5-0-pro) | Build information-led layouts or make a defined precise edit |
...
The English page is [https://flux-art.cn/en/models/nano-banana-2-lite](https://flux-art.cn/en/models/nano-banana-2-lite), and the Chinese page is [https://flux-art.cn/zh/models/nano-banana-2-lite](https://flux-art.cn/zh/models/nano-banana-2-lite). Both links use Flux Art’s permanent entry `flux-art.cn` and redirect to the corresponding current model pages.
...
[Nano Banana 2 Lite](https://flux-art.cn/en/models/nano-banana-2-lite) on [Flux Art](https://flux-art.cn) is positioned for fast 1K drafts. Define one decision question, keep verified product facts fixed, compare a small set of controlled directions as a grid, and preserve the winning brief for final production. Use [Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) for consistent image editing or [GPT Image 2](https://flux-art.cn/en/models/gpt-image-2) for product images and photorealistic commercial photography. Related guides: [Chinese Nano Banana 2 Lite workflow](../models/nano-banana-2-lite.md), [series consistency](../04-series-consistency.md), and [compliance](../06-compliance.md).
