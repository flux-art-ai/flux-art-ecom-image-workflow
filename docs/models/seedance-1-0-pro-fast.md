...
[Seedance 1.0 Pro Fast](https://flux-art.cn/zh/models/seedance-1-0-pro-fast) 在 [Flux Art](https://flux-art.cn) 中可由文字提示词或首帧图片制作产品视频、社媒广告和多镜头短片，并用于更快获得创意反馈。英文页：[Seedance 1.0 Pro Fast (EN)](https://flux-art.cn/en/models/seedance-1-0-pro-fast)。本工作流把它放在成片制作之前：先验证商品出现方式、唯一动作和镜头方向，再把通过审片的方案交给完整产品视频流程。
...
打开 [Flux Art 的 Seedance 1.0 Pro Fast 官方页](https://flux-art.cn/zh/models/seedance-1-0-pro-fast)，按当前页面提供的入口提交文字提示词或首帧图片。选择首帧时，以已审商品图为基准；选择文字时，把商品事实放在镜头描述之前。
