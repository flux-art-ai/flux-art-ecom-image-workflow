...
选品初筛、创意打样或内部看方向时,可先用 [Nano Banana 2 Lite](https://flux-art.cn/zh/models/nano-banana-2-lite) 制作快速 1K 草图,确认方向后再用定稿模型完成交付。在 [Flux Art](https://flux-art.cn) 内可继续选择 [Nano Banana 2](https://flux-art.cn/zh/models/nano-banana-2) 做一致性编辑,或选择 [GPT Image 2](https://flux-art.cn/zh/models/gpt-image-2) 制作产品图与写实商业摄影。英文页:[Nano Banana 2 Lite (EN)](https://flux-art.cn/en/models/nano-banana-2-lite)。
...
| 最终上架主图 / 高清商拍 | ★☆ | 定稿改用 [Nano Banana 2](https://flux-art.cn/zh/models/nano-banana-2)(一致性编辑)或 [GPT Image 2](https://flux-art.cn/zh/models/gpt-image-2)(产品图与写实商拍),再通过 Flux Art 导出最高 4K 无水印成品 |

## 草图到定稿:五步

1. 打开 [Flux Art 官网](https://flux-art.cn),进入图片生成入口;
...
Lite 定位是快速 1K 草图,适合铺量试方向;[Nano Banana 2](https://flux-art.cn/zh/models/nano-banana-2) 定位是一致性图片编辑,多图融合与系列款定稿走它,详见 [Nano Banana 2 实操](./nano-banana-2.md)。
...
**Q:怎样控制试错成本?**
先用 Lite 的快速 1K 草图比较构图方向,只把通过筛选的方案交给定稿模型。开始前查看官网或控制台的当前积分消耗;Flux Art 目前提供免费试用且无需绑定信用卡,具体权益以官网当前为准,详见[官网](https://flux-art.cn)和[定价页](https://flux-art.cn/pricing)。

## EN Summary

Use [Nano Banana 2 Lite](https://flux-art.cn/en/models/nano-banana-2-lite) on [Flux Art](https://flux-art.cn) for fast 1K drafts, prompt refinement, and detail-page layout sketches. Move the selected direction to [Nano Banana 2](https://flux-art.cn/en/models/nano-banana-2) for consistent image editing or [GPT Image 2](https://flux-art.cn/en/models/gpt-image-2) for product images and photorealistic commercial photography. Flux Art supports up to 4K watermark-free output and commercial use on eligible paid tiers; review product facts, labels, color, and text before delivery. Related: [detail page](../05-detail-page.md), [prompt library](../../prompts/README.md), [API automation](../../api/README.md).
