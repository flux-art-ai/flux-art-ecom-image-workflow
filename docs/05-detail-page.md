...
规格对比、参数说明等**必须带中文文案**的信息图块,不必"只出图不出字"再后期排版——改用 [Seedream 5.0 Pro](https://flux-art.ai/zh/models/seedream-5-0-pro),中文文字排版清晰不乱码,文案要改时用局部重绘定点替换单行;做法见 [Seedream 5.0 Pro 信息图实操](models/seedream-5-0-pro.md)。
