...
2. **进入编辑**: Flux Art(flux-art.cc)→ 图片编辑入口 → 上传原图。
3. **选模型**: [Nano Banana 2](https://flux-art.cc/zh/models/nano-banana-2)(14 种宽高比,最高 4K)。
...
| 反光件(玻璃/金属)失真 | 换 [GPT Image 2](https://flux-art.cc/zh/models/gpt-image-2) 写实档重出,或保留实拍只换底 |
